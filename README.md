...
Determining particle density is essential for method 1. If measured particle density and uncertainty data are available, they should be preferred. If measured particle density is unavailable, but the percentage clay is known, then eq. 10 from [Schjønning 2017](https://www.sciencedirect.com/science/article/abs/pii/S001670611630636X) is used to estimate particle density (assuming no organic matter). If the clay content in unknown, then a particle density of 2.65 +/- 0.1 g/cm^3 is used.
